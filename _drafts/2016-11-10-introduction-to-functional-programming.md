...
Unlike programs written using imperative paradigm like C #, Java, C, it uses declarative paradigm. Yes we have 2 more terms to describe (sorry!).

#### What is Imperative Programming?

* There is a thing called variable. Change over time during program operation.
* Allowing assingment to the global state
* Existance of control structures like if-then-else, loops etc.

To be more clear, to explain how a program will work step by step using variable, assignment and control structures.

"How can we tell a program to work without using them already?" you may ask. It is very common in the school or at work always developing the software like this, and not hear it there could be another way of doing that. For this reason, there are situations where learners need to forget about, and it seems that those who enter to programming from scratch can understand and use functional programming more quickly in this sense. I think that one should take this into consideration and get into.

#### What is Declerative Programming?

I start with a direct example because I think it is the most crucial and descriptive: SQL. Yes, SQL is declaritive: In the word sense; it just declares. It tells you what he wants, but he does not care or even know how this request will be met. In fact, we have made the definition of abstraction.

#### Why is abstraction important?

> “Programs must be written for people to read, and only incidentally for machines to execute.” Harold Abelson

Even if it is an exaggerated statement, it is perhaps one of the reasons why we do not use machine code in programming. Because the human brain can only handle 3 or 4 things at a time, we always need to abstract. Abstraction is also very desirable because of the need to review the code regularly. Otherwise we can not continue to develop and maintain complex systems.

#### What is paradigm?

It is a set of accepted rules. When we call the functional programming paradigm, it is actually an attempt to use more of these rules (not too many) that are easier to use in functional languages.
